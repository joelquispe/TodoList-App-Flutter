                                        ...
                                        switch (value) {
                                          ...
                                          case 2:
                                            controller.deleteTask(controller
                                                .listTask.value[index]);
                                            break;
                                        }
                                      }),
                                      title: Text(
                                          "Título: ${controller.listTask.value[index].title} "),
                                      subtitle: Text(
                        ...
                        Obx(
                          () => ListView.builder(
                            ...
                            itemBuilder: ((context, i) {
                              var index = controller.listUsers.value
                                  .indexOf(controller.listUsers.value[i]);
                              return Card(
                                elevation: 9,
                                child: Padding(
                                  padding:
                                      ...
                                      switch (value) {
                                        ...
                                        case 2:
                                          controller.deleteUser(controller
                                              .listUsers.value[index]);
                                          break;
                                      }
                                    }),
                                    title: Text(
                                        "Nombre: ${controller.listUsers.value[index].name}"),
                                    subtitle: Text(
                                        "Apellido: ${controller.listUsers.value[index].lastname}"),
                                  ),
                                ),
                              );
                            }),
